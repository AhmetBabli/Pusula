...
const translations: Translations = {
  ...
  applications_custom_qa_title: { tr: 'Formda Ekstra Sorular Var mı?', en: 'Extra Questions on the Form?' },
  applications_custom_qa_desc: { tr: 'İlanın kendi başvuru formunda gördüğün soruları buraya yapıştır, CV\'ne göre anında cevap taslağı yazayım.', en: "Paste the questions you see on the listing's own application form — I'll draft answers based on your CV." },
  applications_custom_qa_action: { tr: 'Cevaplayalım', en: "Let's Answer" },
  ...
  applications_cover_letter_edit_prompt: { tr: 'Metni beğenmedin mi? Düzenle', en: "Don't like the text? Edit it" },
  applications_cover_letter_chat_title: { tr: 'Mektubu Beğenmedin mi?', en: "Don't Like the Letter?" },
  applications_cover_letter_chat_desc: { tr: '"Daha kısa yaz", "daha resmi olsun" gibi bir talimat ver, mektubu anında düzenleyeyim.', en: "Give an instruction like \"make it shorter\" or \"more formal\" and I'll update the letter instantly." },
  applications_cover_letter_chat_action: { tr: 'Düzenle', en: 'Edit' },
  applications_cover_letter_chat_placeholder: { tr: 'Örn. "daha resmi olsun", "kısalt"...', en: 'e.g. "make it more formal", "shorten it"...' },
  applications_cover_letter_chat_updated: { tr: '✓ Mektup güncellendi, yukarıdan kontrol edebilirsin.', en: '✓ Letter updated — check it above.' },
  applications_cover_letter_chat_error: { tr: 'Düzenlenemedi, tekrar dener misin?', en: 'Could not edit it, try again?' },
  ...
  applications_referral_desc: { tr: 'Aynı üniversiteden biri bu şirkette çalışıyor olabilir — bulup kişiselleştirilmiş bir referans mesajı taslağı hazırlayayım.', en: "Someone from your university might work at this company — I'll find them and draft a personalized referral message." },
  applications_referral_action: { tr: 'Bulalım', en: 'Find Out' },
  ...
  agents_research_info: { tr: 'Google\'da gerçek zamanlı arama yapar, bulduğu açık ilanları "Fırsatlar" sayfana kaydeder.', en: 'Searches Google in real time and saves the open listings it finds to your "Opportunities" page.' },
  ...
  agents_cv_info: { tr: 'GitHub projelerini analiz edip senin için sıfırdan bir CV taslağı yazar ve PDF olarak indirmeni sağlar.', en: 'Analyzes your GitHub projects, writes a CV draft from scratch, and lets you download it as a PDF.' },
  ...
  agents_interview_info: { tr: 'Hedef şirket/pozisyona özel mülakat soruları sorar, verdiğin cevapları puanlayıp geri bildirim verir.', en: 'Asks interview questions tailored to your target company/role, then scores and gives feedback on your answers.' },
  ...
  agents_outreach_info: { tr: 'Bir şirket adı girersin (ilan olsun olmasın), o şirkete özel bir soğuk e-posta + LinkedIn mesaj taslağı yazar. Hiçbir şeyi otomatik göndermez, sen kopyalayıp yollarsın.', en: 'Give it a company name (posting or not) and it drafts a cold email + LinkedIn message for that company. Nothing is sent automatically — you copy and send it yourself.' },
  ...
  agents_events_title: { tr: 'Etkinlik Bulucu', en: 'Event Finder' },
  agents_events_subtitle: { tr: 'Kariyer fuarı, hackathon ve etkinlik araştırması', en: 'Career fair, hackathon, and event research' },
  agents_events_info: { tr: 'Google\'da güncel kariyer fuarı, hackathon ve etkinlikleri bulur, bulduklarını "Etkinlikler" sayfana kaydeder.', en: 'Finds current career fairs, hackathons, and events on Google, and saves them to your "Events" page.' },
  agents_events_found_suffix: { tr: 'yeni etkinlik bulundu ve kaydedildi.', en: 'new events found and saved.' },
  agents_strategy_title: { tr: 'Kariyer Stratejisi', en: 'Career Strategy' },
  agents_strategy_subtitle: { tr: 'Hedef pozisyona 6 aylık yol haritası', en: '6-month roadmap to your target role' },
  agents_strategy_info: { tr: 'Şu anki profilinle hedef pozisyon arasındaki farkı analiz eder; maaş/talep bilgisi, yetenek boşlukları ve 6 aylık kişisel bir yol haritası çıkarır.', en: 'Analyzes the gap between your current profile and your target role, then produces salary/demand info, skill gaps, and a personal 6-month roadmap.' },
  agents_strategy_target_job_placeholder: { tr: 'Hedef pozisyon (örn. Data Scientist)', en: 'Target role (e.g. Data Scientist)' },
  agents_strategy_target_location_placeholder: { tr: 'Hedef lokasyon', en: 'Target location' },
  agents_strategy_generate: { tr: 'Strateji Oluştur', en: 'Generate Strategy' },
  agents_strategy_market_overview: { tr: 'Pazar Genel Bakışı', en: 'Market Overview' },
  agents_strategy_salary_range: { tr: 'Maaş Aralığı', en: 'Salary Range' },
  agents_strategy_demand_level: { tr: 'Talep Seviyesi', en: 'Demand Level' },
  agents_strategy_top_technologies: { tr: 'Öne Çıkan Teknolojiler', en: 'Top Technologies' },
  agents_strategy_skill_gaps: { tr: 'Yetenek Boşlukları', en: 'Skill Gaps' },
  agents_strategy_roadmap: { tr: '6 Aylık Yol Haritası', en: '6-Month Roadmap' },
  agents_strategy_project_ideas: { tr: 'Proje Fikirleri', en: 'Project Ideas' },
  agents_strategy_final_advice: { tr: 'Son Tavsiye', en: 'Final Advice' },
  ...
  profile_github_desc: { tr: 'CV Oluşturucu ve Kariyer Stratejisi, repo\'larını analiz etmek için bunu kullanır.', en: 'The CV Builder and Career Strategy tool use this to analyze your repos.' },
  profile_linkedin_desc: { tr: 'Profil linkin — otomatik veri çekilmez, aşağıya kendin yapıştırırsın.', en: "Your profile link — data isn't fetched automatically, you paste it below yourself." },
  profile_save_connections: { tr: 'Bağlantıları Kaydet', en: 'Save Connections' },
  profile_linkedin_data_label: { tr: 'LinkedIn Profil Verisi (opsiyonel)', en: 'LinkedIn Profile Data (optional)' },
  profile_linkedin_data_hint: { tr: 'LinkedIn, herkese açık verini otomatik çekmemize izin vermiyor. Profilindeki Deneyim, Eğitim ve Beceriler bölümlerini kopyalayıp buraya yapıştır — CV Oluşturucu ve Kariyer Stratejisi bunu kullanır.', en: "LinkedIn doesn't allow us to fetch your public data automatically. Copy the Experience, Education, and Skills sections from your profile and paste them here — the CV Builder and Career Strategy tool will use it." },
  profile_linkedin_data_placeholder: { tr: 'Deneyim:\n...\n\nEğitim:\n...\n\nBeceriler:\n...', en: 'Experience:\n...\n\nEducation:\n...\n\nSkills:\n...' },
