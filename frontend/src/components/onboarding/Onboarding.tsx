...
import { FileText, Radar, Mail, ArrowRight, BrainCircuit } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-surface text-on-surface px-6 py-12 relative overflow-hidden">
      <div className="relative z-10 max-w-5xl w-full flex flex-col items-center text-center">
        ...
        <motion.div 
          ...
          className="w-16 h-16 rounded-2xl bg-primary-container/10 border border-primary-container/20 flex items-center justify-center mb-8"
        >
        ...
        <motion.div 
          ...
          className="text-xs font-label text-primary tracking-[0.2em] mb-4 uppercase border border-primary-container/30 px-4 py-1.5 rounded-full bg-primary-container/10"
        >
