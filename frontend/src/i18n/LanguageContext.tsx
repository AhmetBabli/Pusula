...
const translations: Translations = {
  ...
  nav_interview: { tr: 'Mülakat Koçu', en: 'Interview Coach' },
  ...
  events_search_query_placeholder: { tr: 'Ara (örn. hackathon)', en: 'Search (e.g. hackathon)' },
  events_search_button: { tr: 'Etkinlik Ara', en: 'Search Events' },
  events_searching: { tr: 'Aranıyor...', en: 'Searching...' },
  ...
  interview_listen_question: { tr: 'Soruyu sesli dinle', en: 'Listen to the question' },
  interview_start_listening: { tr: 'Konuşarak yanıtla', en: 'Answer by speaking' },
  interview_stop_listening: { tr: 'Dinlemeyi durdur', en: 'Stop listening' },
  interview_listening_active: { tr: 'Dinleniyor... konuşun', en: 'Listening... please speak' },
  ...
  interview_mic_error_not_allowed: { tr: 'Mikrofon izni verilmedi. Tarayıcı adres çubuğundan mikrofona izin verin.', en: 'Microphone permission was denied. Allow microphone access from the browser address bar.' },
  interview_mic_error_no_device: { tr: 'Mikrofon bulunamadı. Bir mikrofonun bağlı ve seçili olduğundan emin olun.', en: 'No microphone found. Make sure a microphone is connected and selected.' },
  interview_mic_error_network: { tr: 'Konuşma tanıma servisine ulaşılamıyor (bağlantı sorunu olabilir).', en: 'Cannot reach the speech recognition service (possible connection issue).' },
  interview_mic_error_no_speech: { tr: 'Hiçbir konuşma algılanmadı. Mikrofonun doğru cihaz olduğundan emin olup tekrar deneyin.', en: 'No speech was detected. Make sure the right microphone is selected and try again.' },
  interview_mic_error_unknown: { tr: 'Mikrofon ile ilgili bir sorun oluştu.', en: 'A microphone-related problem occurred.' },
  interview_mic_error_start_failed: { tr: 'Bu tarayıcı konuşma tanımayı başlatamadı — bazı tarayıcılarda bu özellik desteklenmiyor. Google Chrome veya Microsoft Edge ile denemeyi deneyin.', en: 'This browser could not start speech recognition — some browsers don\'t support this feature. Try Google Chrome or Microsoft Edge instead.' },
  interview_exit_room: { tr: 'Odadan çık', en: 'Leave the room' },
  interview_switch_to_typing: { tr: 'Yazarak cevapla', en: 'Answer by typing' },
  interview_switch_to_voice: { tr: 'Sesli cevaba dön', en: 'Back to voice answer' },
  interview_voice_prompt: { tr: 'Konuşmaya başlayın, söyledikleriniz burada görünecek...', en: 'Start speaking, what you say will appear here...' },
  ...
  interview_mascot_greeting: { tr: 'Merhaba! Pusula\'ya hoş geldin. Hangi şirket için mülakat provası yapmak istersin?', en: 'Hello! Welcome to Pusula. Which company would you like to do a mock interview for?' },
  interview_mascot_ask_department: { tr: 'Harika. Peki hangi pozisyon ya da bölüm için hazırlanalım?', en: 'Great. And which position or department should we prepare for?' },
  interview_researching_1: { tr: 'Şirketi araştırıyorum...', en: 'Researching the company...' },
  interview_researching_2: { tr: 'Mülakat tarzını ve kültürünü inceliyorum...', en: 'Looking into their interview style and culture...' },
  interview_researching_3: { tr: 'Sana özel sorular hazırlıyorum...', en: 'Preparing questions tailored to you...' },
  interview_user_label: { tr: 'Sen', en: 'You' },
  interview_retry: { tr: 'Tekrar Dene', en: 'Try Again' },
  ...
  entry_cancel: { tr: 'Vazgeç', en: 'Cancel' },
  experience_section_title: { tr: 'İş Deneyimi', en: 'Work Experience' },
  experience_add_label: { tr: 'Deneyim ekle', en: 'Add experience' },
  experience_empty_label: { tr: 'Henüz iş deneyimi eklemedin. CV\'ni güçlendirmek için staj/iş deneyimlerini ekleyebilirsin.', en: 'No work experience added yet. Add your internships/jobs to strengthen your CV.' },
  experience_field_title: { tr: 'Pozisyon', en: 'Title' },
  experience_field_title_placeholder: { tr: 'Örn. Yazılım Stajyeri', en: 'e.g. Software Intern' },
  experience_field_company: { tr: 'Şirket', en: 'Company' },
  experience_field_company_placeholder: { tr: 'Örn. Turkcell', en: 'e.g. Turkcell' },
  experience_field_start: { tr: 'Başlangıç', en: 'Start' },
  experience_field_end: { tr: 'Bitiş', en: 'End' },
  experience_field_current: { tr: 'Hâlâ devam ediyor', en: 'Currently working here' },
  experience_field_description: { tr: 'Açıklama', en: 'Description' },
  experience_field_description_placeholder: { tr: 'Ne yaptığını kısaca anlat...', en: 'Briefly describe what you did...' },
  experience_current_label: { tr: 'Devam ediyor', en: 'Present' },
  certificate_section_title: { tr: 'Sertifikalar', en: 'Certificates' },
  certificate_add_label: { tr: 'Sertifika ekle', en: 'Add certificate' },
  certificate_empty_label: { tr: 'Henüz sertifika eklemedin.', en: 'No certificates added yet.' },
  certificate_field_name: { tr: 'Sertifika Adı', en: 'Certificate Name' },
  certificate_field_name_placeholder: { tr: 'Örn. AWS Cloud Practitioner', en: 'e.g. AWS Cloud Practitioner' },
  certificate_field_issuer: { tr: 'Veren Kurum', en: 'Issuing Organization' },
  certificate_field_issuer_placeholder: { tr: 'Örn. Amazon', en: 'e.g. Amazon' },
  certificate_field_date: { tr: 'Tarih', en: 'Date' },
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  // LanguageContext neredeyse her bileşen tarafından tüketiliyor — value
  // objesi her render'da yeniden oluşturulursa (memoize edilmeden) tüm
  // tüketiciler gereksiz yere yeniden render olur.
